...
const LOCATIONS: Record<string, Location> = {
  ...
  jeddah: {
    name: 'بنون – جدة',
    address: 'حي الأندلس، جدة، المملكة العربية السعودية',
  ...
  alahsa: {
    name: 'بنون – الأحساء',
    address: 'طريق الملك فهد، الأحساء، المملكة العربية السعودية',
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div className="text-right">
            ...
            <p className="mb-10 text-sm leading-relaxed text-zinc-500 max-w-md mr-0 ml-auto">
              مواقعنا موزعة بشكل مريح لخدمة العائلات في جميع أنحاء المملكة العربية السعودية من خلال خمس مراكز عالمية المستوى.
            </p>
            ...
            <div className="flex flex-col gap-4">
              {(Object.entries(LOCATIONS) as [keyof typeof LOCATIONS, Location][]).map(([key, location]) => (
                <button
                  ...
                  className={`flex items-center justify-between p-6 text-right transition-colors border-2 rounded-2xl group ${
                    activeTab === key
