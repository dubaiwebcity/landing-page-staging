...
`,
    ...
    {
        author: 'Sadal Ainoosah',
        meta: '7 تقييمات',
        text: `نود ان نتقدم بجزيل الشكر لجميع منسوبي بنون على اهتمامهم و رعايتهم و نخص بالذكر دكتوري العزيز دكتور مازن بشارة ربي يبارك فيه و يحفظه على اهتمامه البالغ و حرصه اللامحدود .. حقيقي الأب و الدكتور في نفس الوقت ..
         و ما انسى الاستاذة شيماء في الاستقبال ماشاء الله تبارك الله على تعاملها الراقي جدا و أدبها الرفيع.. جدا لطيفة و متعاونة معانا ربي يبارك فيها و يحفظها و يكرمها .. شكرا استاذة شيماء`,
    }, 
];
