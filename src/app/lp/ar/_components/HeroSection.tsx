...
export default function HeroSection() {
    ...
    return ( 
        <section
            className="relative flex items-center min-h-screen bg-size-[100%_auto] bg-cover bg-no-repeat bg-top md:bg-center bg-[url('/images/Banner--Size-4.jpg')] md:bg-[url('/images/Family.png?v3')]"
        >
