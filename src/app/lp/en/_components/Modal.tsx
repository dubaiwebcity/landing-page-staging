          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/2 p-8 sm:p-10 bg-white">
              <div className="flex justify-between items-start">
                ...
                <button
                  onClick={onClose}
                  className="text-slate-400 hover:text-slate-500 hover:bg-slate-100 p-2 rounded-full transition-colors relative z-20"
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                <div>
                  <label className="block mb-1.5 text-xs font-bold tracking-wide text-slate-400 uppercase">Name</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full py-2.5 pl-9 pr-3 text-sm font-medium transition border rounded-xl bg-slate-50/50 border-slate-200 text-slate-700 focus:outline-none focus:border-[#38bdf8] focus:ring-1 focus:ring-[#38bdf8] placeholder-slate-400"
                    />
                  </div>
                </div>

                <div>
                  <label className="block mb-1.5 text-xs font-bold tracking-wide text-slate-400 uppercase">Phone</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-4 h-4 text-slate-400">
