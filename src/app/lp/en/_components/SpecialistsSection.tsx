...
const REELS = [
  ...
  },
  {
    ...
    permalink: 'https://www.instagram.com/reel/DXbfhX2CkLm/?utm_source=ig_embed&utm_campaign=loading',
  },
  {
    url: 'https://www.instagram.com/reel/DWRtb4eig96/?utm_source=ig_embed&utm_campaign=loading',
    permalink: 'https://www.instagram.com/reel/DWRtb4eig96/?utm_source=ig_embed&utm_campaign=loading',
  },
];

export default function SpecialistsSection() {
  return (
    <section id="specialists" className="py-16 mx-1 mt-4 rounded-2xl bg-[#f4f9fc]">
      <div className="px-8 mx-auto max-w-7xl">
        <div className="mx-auto mb-10 w-full max-w-4xl sm:px-12">
          ...
          <p className="mx-auto mb-14 max-w-xl text-xl font-bold text-center lg:text-2xl">
            Clinical Perspectives on Ḟertility &amp; IVḞ
          </p>
        </div>

        <div className="flex flex-col gap-8 lg:flex-row">
          {REELS.map((reel) => (
            <div key={reel.url} className="overflow-hidden aspect-[7/16] relative flex-1">
        ...
        <div className="flex justify-center mt-10">
          <a
            href="https://www.instagram.com/bnoonivf/"
            target="_blank"
