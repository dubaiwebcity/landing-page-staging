...
export default function HeroSection() {
    ...
    return (
        <section
            className="relative flex items-center min-h-screen bg-cover bg-no-repeat bg-top md:bg-center bg-[url('/images/Banner--Size-4-en.jpg')] md:bg-[url('/images/Family-en.png?v3')]"
        >
