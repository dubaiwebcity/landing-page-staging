...
const LOCATIONS: Record<string, Location> = {
  riyadh: {
    name: 'Bnoon - Riyadh',
    type: '',
    address: 'Abu Jafar Bin Mansur Street, Al Shuhada District, Riyadh',
  ...
  jeddah: {
    name: 'Bnoon - Jeddah',
    type: '',
    address: 'Quartz Building, Al Cornishe Road, Al Shatea District, Jeddah',
  ...
  alahsa: {
    name: 'Bnoon - Al Ahsa',
    type: '',
    address: 'Dhahran Road, Al Faisal District, Al Ahsa, Almoosa Specialist Hospital, Floor 12, South Tower',
  ...
  kingsalman: {
    name: 'Bnoon - King Salman Road (Opening Soon)',
    type: '',
    address: 'King Salman Road, Riyadh',
        ...
        <div className="grid grid-cols-1 gap-4 md:gap-16 lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-1 md:gap-4">
              {(Object.entries(LOCATIONS) as [keyof typeof LOCATIONS, Location][]).map(([key, location]) => (
                <button
                  ...
                  className={`flex items-center justify-between p-4 md:p-6 text-left transition-colors border-2 rounded-2xl group ${
                    activeTab === key
          ...
          <div className="flex items-center lg:justify-end">
            <div className="w-full max-w-lg p-4 md:p-10 bg-white border shadow-[0_20px_50px_rgb(0,0,0,0.04)] border-zinc-100 rounded-[2rem]">
              ...
              <h3 className="mb-10 text-3xl font-normal text-[#0a192f]">
                {loc.name}
              </h3>
              ...
              <div className="flex flex-col gap-8 mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="block mb-1 text-[10px] font-bold tracking-widest text-zinc-400 uppercase">Address</span>
                ...
                {/* <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="block mb-1 text-[10px] font-bold tracking-widest text-zinc-400 uppercase">Phone</span>
